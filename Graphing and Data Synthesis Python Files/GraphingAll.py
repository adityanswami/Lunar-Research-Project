...
x_Axes_List = ["Standardized Position", "Standardized Longitude", "Standardized Latitude", "Standardized Clinopyroxene Abundance", "Standardized FeO Abundance", "Standardized TerrainHeight",
...
y_Axes_List = ["Standardized Clinopyroxene Abundance", "Standardized FeO Abundance", "Standardized TerrainHeight", "Standardized Iron Abundance", "Standardized Olivine Abundance",
               "Standardized Orthopyroxene Abundance", "Standardized Plagioclase Abundance", "Standardized TerrainSlope", "Standardized Titanium Abundance"]
count = 0
        ...
        for y_value in y_Axes_List:
            ...
            for x_value in x_Axes_List:
                ...
                if mariaOrHighlands == "maria":
                    ...
                    label = "LSRL: slope = " + str(slope) + ", intercept = " + str(intercept) + ", r = " + str(rvalue)
                ...
                fig.tight_layout()
                fig.savefig("C:\\Users\\adity\\School\\ExMASS\\Data Analysis\\Graphs\\Line Fits of Standardized Datapoints\\" + y_Axis + " vs\\" + y_Axis +
