...
x_Axes_List = ["FeO Abundance", "Iron Abundance", "Orthopyroxene Abundance", "Plagioclase Abundance",
               "Titanium Abundance"]
y_Axes_List = ["Clinopyroxene Abundance", "FeO Abundance", "Iron Abundance", "Orthopyroxene Abundance", "Plagioclase Abundance"]
count = 0
