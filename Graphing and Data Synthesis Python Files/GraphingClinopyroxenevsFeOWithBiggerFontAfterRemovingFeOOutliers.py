...
x_Axes_List = ["FeO Abundance"]
y_Axes_List = ["Clinopyroxene Abundance"]
count = 0
    ...
    for geography in mHBoth:
        for y_value in y_Axes_List:
            ...
            for x_value in x_Axes_List:
                ...
                fig.tight_layout()
                fig.savefig("C:\\Users\\adity\\ExMASS\\Data Analysis\\Graphs\\Line Fit - Bigger Font\\" + y_Axis + " vs\\" + x_Axis + " Outliers Removed\\" + y_Axis +
